...
- Format: modified ladder, players with same scores play each other in ladder format (to make all games competitive). 6 player example: Round 1 pairings: 1-2,4-3,5-6, 1 wins, 4-3 draw, 5 wins. Round 2 pairings:  5-1 (both players with 1 point), 3-2, 6-4. Note that no player is guarenteed to play both white and black.
