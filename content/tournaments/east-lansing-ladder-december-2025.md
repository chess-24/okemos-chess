...
### Standard Entry
The standard entry is $19 for active United States Chess Federation (USCF) members, if paid before Friday, December 19, 10 PM EST. Add $5 afterwards. **[Standard Registration Form](https://forms.gle/pYXkLJw8BPjHdCsz9)**
...
- Format: modified ladder, players with same scores play each other in ladder format (to decrease rating differential). Example with 6 players, round 1 pairings: 1-2,4-3,5-6, 1 wins, 4-3 draw, 5 wins, round 2 pairings:  5-1 (both players with 1 point), 3-2 (3 is highest 1/2 point), 6-4. Note that no player is guarenteed to play both white and black.
